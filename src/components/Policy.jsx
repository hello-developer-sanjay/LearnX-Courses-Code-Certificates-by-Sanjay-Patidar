...
const Policy = () => {
    ...
    return (
        <Container>
            {!policyAccepted ? (
                <div>
                    <Heading>Welcome to LearnX by hogwartsedx</Heading>
                    <Paragraph>
                    ...
                    <Paragraph>
                        To exercise these rights, please contact us at <Link href="mailto:privacy@LearnX.com" aria-label="Email privacy team at LearnX">privacy@LearnX.com</Link>. For more information, visit the official <Link href="https://www.meity.gov.in/content/cyber-laws" aria-label="Visit the IT Act official website">IT Act website</Link>.
                    </Paragraph>
                    ...
                    <Paragraph>
                        If you have any questions or concerns about our privacy policy, please contact us at <Link href="mailto:privacy@LearnX.com" aria-label="Email privacy team at LearnX">privacy@LearnX.com</Link>.
                    </Paragraph>
